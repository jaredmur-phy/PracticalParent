...
public class EditTaskListActivity extends AppCompatActivity {
    ...
    private void registerClickCallBack() {
        ListView list = findViewById(R.id.id_edit_task_list_view);
    ...
    private void setToolBar() {
        Toolbar toolbar = findViewById(R.id.id_edit_task_tool_bar);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.id_action_delete_settings:
                startActivity(DeleteTaskListActivity.makeLaunchIntent(this));
                return true;
            default:
                finish();
